...
const FeaturesTiles = ({
  ...
  const sectionHeader = {
    ...
    paragraph: 'Cannabis is a wonder plant known for its many benefits from medicinal to industrial and we are here to help you understand and use this super plant LEGALLY! '
  };
